...
public class singerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(singerActivity.this, "點播 " + selectedUnit, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onInsertButtonClick(View view) {
        ...
        Toast.makeText(singerActivity.this, "插播 " + buttonText, Toast.LENGTH_SHORT).show();
    }
    ...
    private void searchSong(final String query) {
        new AsyncTask<Void, Void, List<Song>>() {
            @Override
            protected List<Song> doInBackground(Void... voids) {
                return songsDbHelper.searchSongsByArtist(query);
            }
